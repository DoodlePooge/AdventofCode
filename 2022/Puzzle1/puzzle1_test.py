from puzzle1 import find_max_calories_held, add_calories_held, traverse_file, find_top_three_calories_held
...
def test_find_top_three_calories_held() -> None:
    max = find_top_three_calories_held(elves)
    assert max == 45000